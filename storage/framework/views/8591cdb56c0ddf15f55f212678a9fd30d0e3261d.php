...
<head>
    ...
    <!-- CSS Files -->
    <link href="<?php echo e(asset('admin/assets/css/material-dashboard.css?v=2.1.1')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('admin/assets/css/material-kit.css?v=2.0.5')); ?>" rel="stylesheet" />
...
<?php endif; ?>
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <li>
                        <form action="" method="GET" class="form-group form-inline bmd-form-group" id="search">
                            <?php echo csrf_field(); ?>
                            <input type="search" value="<?php echo e(request()->search); ?>" name="search" class="form-control"
                                placeholder="Search">
    ...
    <div class="page-header header-filter" data-parallax="true"
        style="background-image: url('<?php echo e(asset('admin/assets/image/bgr-rainroad.jpeg')); ?>')">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="title"></h1>
    ...
    <!--   Core JS Files   -->
    <script src="<?php echo e(asset('admin/assets/js/core/jquery.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('admin/assets/js/core/popper.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('admin/assets/js/core/bootstrap-material-design.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('admin/assets/js/plugins/moment.min.js')); ?>"></script>
    <!--	Plugin for the Datepicker, full documentation here: https://github.com/Eonasdan/bootstrap-datetimepicker -->
    <script src="<?php echo e(asset('admin/assets/js/plugins/bootstrap-datetimepicker.js')); ?>" type="text/javascript"></script>
    <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
    <script src="<?php echo e(asset('admin/assets/js/plugins/nouislider.min.js')); ?>" type="text/javascript"></script>
    <!--  Google Maps Plugin    -->
    <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
    <!-- Control Center for Material Kit: parallax effects, scripts for the example pages etc -->
    <script src="<?php echo e(asset('admin/assets/js/material-kit.js?v=2.0.5x')); ?>" type="text/javascript"></script>
    <div id="fb-root"></div>
...
<?php /**PATH /media/thinhhoang/Data1/Data/Tai lieu hoc tap/PTPM huong dich vu/MyProject/resources/views/admin/app.blade.php ENDPATH**/ ?>