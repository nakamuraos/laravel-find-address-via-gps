    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark @if (isset($maps) && $maps === true) fixed-top @else sticky-top @endif">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                <li class="nav-item"><a class="nav-link" href="/login"><i class="fas fa-sign-out-alt"></i>
                        @lang('auth.login')</a></li>
                <li class="nav-item"><a class="nav-link" href="/register"><i class="fas fa-user"></i>
                        @lang('auth.register')</a></li>
                @endif
            </ul>
        </div>
    </nav>
