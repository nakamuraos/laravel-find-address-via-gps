                                ...
                                <div class="container" id="place">
                                    <div class="search-form-box">
                                        ...
                                        <form action="#" class="search-form">
                                            <input type="text" placeholder="Nhập địa chỉ cần tới" name="location" id="gps" style="width:80%;display: inline;" data-location="" autocomplete="off"> <button id="located" style="width: 18%">GPS</button>
